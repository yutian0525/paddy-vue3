  ...
  methods: {
    ...
    setOptions() {
      let list = [
        {
          name: '耕地占比',
          value: calculateProportion(this.data.arableLandArea, this.data.totalGrainOutput)
        },
        {
          name: '粮食自给率',
          value: calculateProportion(this.data.totalGrainOutput, this.data.arableLandArea)
        },
        {
          name: '机械化率',
          value: this.data.mechanizationRate
        }
      ]
